  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4 max-h-[30vh] sm:max-h-[40vh] md:max-h-[50vh] overflow-y-auto p-2 bg-slate-800 rounded-lg shadow-inner">
          {heroPool.map(hero => {
